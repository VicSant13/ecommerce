...
<body class="aimeos">
	<nav class="navbar navbar-expand-md navbar-light">
		<a class="navbar-brand" href="/">
			<img src="{{ asset('/logo_light.png')}}"  height="50" title="Your Logo">
		</a>
	...
	<footer class="mt-5 p-5">
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					<div class="col-sm-6 my-4"><h2>{{ __('LEGAL') }}</h2><p><a href="#">{{ __('Terms & Conditions') }}</a></p><p><a href="#">{{ __('Privacy Notice') }}</a></p></div>
					<div class="col-sm-6 my-4"><h2>{{ __('ABOUT US') }}</h2><p><a href="#">{{ __('Contact us') }}</a></p></div>
				</div>
			</div>
			<div class="col-md-4 my-4">
				...
				<a class="px-2 py-4 d-inline-block" href="/"><img src="{{ asset('/logo_light.png')}}" style="width: 160px" title="Your Logo"></a>
			</div>
		</div>
	</footer>
	<!-- Scripts -->
